...
public class completed extends Fragment {
    ...
    ListView donelv;
    ArrayList<String> doneal=new ArrayList<>();
    ArrayAdapter<String> doneaa;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        doneaa=new ArrayAdapter<>(getContext(),android.R.layout.simple_list_item_1,doneal);
        donelv=v.findViewById(R.id.ListViewMessAppComp);
        ...
        doneRef=pendRef.child("DONE");
        pendRef=pendRef.child("PENDING");
        donelv.setAdapter(doneaa);


        doneRef.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                doneal.add(idandorder);
                doneaa.notifyDataSetChanged();
...
/*
        donelv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                TextView temptextview=(TextView)view;
                onRef.child(orderData.ordernkey.get(temptextview.getText().toString())).removeValue();
                doneRef.push().setValue(orderData.ordernobject.get(temptextview.getText().toString()));
